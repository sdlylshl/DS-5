 ...
 * @param delay Retransmit delay in 祍. Must be a
*/
...
*/
bool hal_nrf_get_irq_mode(_nrf_chip_t *nrf_chip, uint8_t int_source);
...
*/
void hal_nrf_set_lna_gain(_nrf_chip_t *nrf_chip, bool lna_gain);

...
SOURCEFILES_QUOTED_IF_SPACED=Source/Nordic/hal_nrf_hw.c Source/Nordic/nrf24l01p.c Source/Nordic/nrf24l01p/hal_nrf.c Source/System/tmr0.c Source/System/mcc.c Source/System/pin_manager.c Source/System/interrupt_manager.c Source/System/spi.c Source/main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1 ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1 ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1 ${OBJECTDIR}/Source/System/tmr0.p1 ${OBJECTDIR}/Source/System/mcc.p1 ${OBJECTDIR}/Source/System/pin_manager.p1 ${OBJECTDIR}/Source/System/interrupt_manager.p1 ${OBJECTDIR}/Source/System/spi.p1 ${OBJECTDIR}/Source/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1.d ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1.d ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1.d ${OBJECTDIR}/Source/System/tmr0.p1.d ${OBJECTDIR}/Source/System/mcc.p1.d ${OBJECTDIR}/Source/System/pin_manager.p1.d ${OBJECTDIR}/Source/System/interrupt_manager.p1.d ${OBJECTDIR}/Source/System/spi.p1.d ${OBJECTDIR}/Source/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1 ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1 ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1 ${OBJECTDIR}/Source/System/tmr0.p1 ${OBJECTDIR}/Source/System/mcc.p1 ${OBJECTDIR}/Source/System/pin_manager.p1 ${OBJECTDIR}/Source/System/interrupt_manager.p1 ${OBJECTDIR}/Source/System/spi.p1 ${OBJECTDIR}/Source/main.p1

# Source Files
SOURCEFILES=Source/Nordic/hal_nrf_hw.c Source/Nordic/nrf24l01p.c Source/Nordic/nrf24l01p/hal_nrf.c Source/System/tmr0.c Source/System/mcc.c Source/System/pin_manager.c Source/System/interrupt_manager.c Source/System/spi.c Source/main.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1: Source/Nordic/hal_nrf_hw.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Source/Nordic" 
	@${RM} ${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1.d 
	@${RM} ${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1  Source/Nordic/hal_nrf_hw.c 
	@-${MV} ${OBJECTDIR}/Source/Nordic/hal_nrf_hw.d ${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Source/Nordic/hal_nrf_hw.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/Source/Nordic/nrf24l01p.p1: Source/Nordic/nrf24l01p.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Source/Nordic" 
	@${RM} ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1.d 
	@${RM} ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/Source/Nordic/nrf24l01p.p1  Source/Nordic/nrf24l01p.c 
	@-${MV} ${OBJECTDIR}/Source/Nordic/nrf24l01p.d ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Source/Nordic/nrf24l01p.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1: Source/Nordic/nrf24l01p/hal_nrf.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/Source/Nordic/nrf24l01p" 
	@${RM} ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1.d 
	@${RM} ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1  Source/Nordic/nrf24l01p/hal_nrf.c 
	@-${MV} ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.d ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Source/Nordic/nrf24l01p/hal_nrf.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  

...
//#define CAN_MSR_INAK     ((u32)0x00000000)	   /*not initialization acknowledeg*/
...
u8 CAN_MessagePending(u8 FIFONumber)
{
  ...
  if (FIFONumber == CAN_FIFO0)
  {
    MessagePending = (u8)(CAN->RF0R&(u32)0x03); /*Store how many messages are pending in the receive FIFO*/ 
  }

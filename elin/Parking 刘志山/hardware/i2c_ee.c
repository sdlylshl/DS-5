...
void save_CardNr_to_EEPROM()
{
	AT24CXX_Write(0, (u8*)&cardNr, 1);
}

uint8_t read_CardNr_from_EEPROM()
{
	AT24CXX_Read(0, (u8*)&cardNr, 1);
	return cardNr;
}
...
//		if(sys->text.text_group < 6)
//		{
//			for(i=0; i<(sys->text.text_group); i++)
//			{

...
#define WIZ_SCS_A_4				GPIO_Pin_4	// out
#define WIZ_SCLK_A_5			GPIO_Pin_5	// out
#define WIZ_MISO_A_6			GPIO_Pin_6	// in
#define WIZ_MOSI_A_7			GPIO_Pin_7	// out
#define WIZ_INT_A_1		    	GPIO_Pin_1
#define WIZ_RESET_A_0		    GPIO_Pin_0


extern uint8_t TX_BUF[8][TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_1[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_2[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_3[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_4[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_5[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_6[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_7[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications
//extern uint8_t TX_BUF_8[TX_RX_MAX_BUF_SIZE]; // TX Buffer for applications

extern uint8_t BUF_WRITE[8];
extern uint8_t BUF_READ[8];
